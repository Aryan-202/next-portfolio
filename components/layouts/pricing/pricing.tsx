    ...
    return (
        <section id="pricing" className="py-20 px-4 scroll-animate bg-muted/30">
            <div className="container mx-auto max-w-6xl">
                ...
                >
                    <h2 className="text-4xl lg:text-5xl font-bold mb-4">Pricing Services</h2>
                    <div className="w-24 h-1 bg-primary mx-auto mb-6"></div>
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        Transparent pricing based on business value and complexity.
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {MAINTENANCE_PLAN.features.map((feature) => (
