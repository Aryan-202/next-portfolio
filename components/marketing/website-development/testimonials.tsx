                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <h2 className="text-2xl md:text-4xl font-medium mb-10 leading-relaxed italic">
                            &ldquo;The website was delivered on time and performs incredibly well. From the speed to the flawless design, highly recommended for any growing brand.&rdquo;
                        </h2>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-xl font-bold tracking-tight text-foreground uppercase">Business Owner</span>
                            <span className="text-brand-secondary/80 text-sm font-medium">B2B Service Client</span>
                        </div>
                    </motion.div>
                </div>
            </div>
