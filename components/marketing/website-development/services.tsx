...
const services = [
    {
        ...
        description: "Complete website build from scratch, fully customized to your brand and business goals.",
        icon: Code,
        tag: "Tailored Creation"
    },
    {
        number: "02",
        title: "Website Redesign",
        description: "Upgrade and modernize outdated websites for significantly better performance & UX.",
        icon: RefreshCw,
        tag: "Modernization"
    },
    {
        ...
        description: "Secure, robust, and scalable online stores designed to handle high volume and drive sales.",
        icon: ShoppingBag,
        tag: "Sales Optimized"
    },
    {
        ...
        description: "Custom dashboards, authentication systems, and deep automation for your existing sites.",
        icon: ServerCog,
        tag: "Tech Foundation"
    }
];
